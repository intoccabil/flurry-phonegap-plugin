...
(function(window) {
    ...
    // key is a string
    Flurry.prototype.startSession = function(successCallback,failureCallback) {
    ...
    Flurry.prototype.setLogEvents = function(logEvents, successCallback, failureCallback) {
        return cordova.exec( successCallback, failureCallback, 'FlurryPlugin', 'setLogEvents', [logEvents]);
    };
